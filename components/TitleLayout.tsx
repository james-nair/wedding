  ...
  return (
    ...
    >
      <Layout isPortrait={isPortrait}>
        <SubtitleLayout isSmall={isSmall} variant={isSmall ? "h3" : "h2"}>
          Save The Date
        </SubtitleLayout>
        <TitleLayout isSmall={isSmall} variant={isSmall ? "h2" : "h1"}>
          {config.groom.name}
          <br />
          &amp;
          <br />
        ...
        <SubtitleLayout variant={isSmall ? "h3" : "h2"} isSmall={isSmall}>
          <>
